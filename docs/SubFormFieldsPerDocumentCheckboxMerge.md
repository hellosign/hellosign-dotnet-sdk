# HelloSign.Model.SubFormFieldsPerDocumentCheckboxMerge
...
**Type** | **string** | REPLACE_ME_WITH_DESCRIPTION_BEGIN A checkbox field that has default value set using pre-filled data. Use the &#x60;SubFormFieldsPerDocumentCheckboxMerge&#x60; class. REPLACE_ME_WITH_DESCRIPTION_END | [default to "checkbox-merge"]
