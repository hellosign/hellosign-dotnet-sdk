...
namespace Org.HelloSign.Api
{
    ...
    public partial class AccountApi : IAccountApi
    {
        ...
        /// <returns></returns>
        public AccountApi(Org.HelloSign.Client.Configuration configuration)
        {
        ...
        public AccountApi(Org.HelloSign.Client.ISynchronousClient client, Org.HelloSign.Client.IAsynchronousClient asyncClient, Org.HelloSign.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.HelloSign.Client.ApiResponse<AccountCreateResponse> localVarResponse = AccountCreateWithHttpInfo(accountCreateRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountCreateResponse</returns>
        public Org.HelloSign.Client.ApiResponse<AccountCreateResponse> AccountCreateWithHttpInfo(AccountCreateRequest accountCreateRequest, int operationIndex = 0)
        {
            // verify the required parameter 'accountCreateRequest' is set
            if (accountCreateRequest == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'accountCreateRequest' when calling AccountApi->AccountCreate");
            }
        ...
        {
            Org.HelloSign.Client.ApiResponse<AccountCreateResponse> localVarResponse = await AccountCreateWithHttpInfoAsync(accountCreateRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountCreateResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<AccountCreateResponse>> AccountCreateWithHttpInfoAsync(AccountCreateRequest accountCreateRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountCreateRequest' is set
            if (accountCreateRequest == null)
            {
        ...
        {
            Org.HelloSign.Client.ApiResponse<AccountGetResponse> localVarResponse = AccountUpdateWithHttpInfo(accountUpdateRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountGetResponse</returns>
        public Org.HelloSign.Client.ApiResponse<AccountGetResponse> AccountUpdateWithHttpInfo(AccountUpdateRequest accountUpdateRequest, int operationIndex = 0)
        {
            // verify the required parameter 'accountUpdateRequest' is set
            if (accountUpdateRequest == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'accountUpdateRequest' when calling AccountApi->AccountUpdate");
            }
        ...
        {
            Org.HelloSign.Client.ApiResponse<AccountGetResponse> localVarResponse = await AccountUpdateWithHttpInfoAsync(accountUpdateRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountGetResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<AccountGetResponse>> AccountUpdateWithHttpInfoAsync(AccountUpdateRequest accountUpdateRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountUpdateRequest' is set
            if (accountUpdateRequest == null)
            {
        ...
        {
            Org.HelloSign.Client.ApiResponse<AccountVerifyResponse> localVarResponse = AccountVerifyWithHttpInfo(accountVerifyRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AccountVerifyResponse</returns>
        public Org.HelloSign.Client.ApiResponse<AccountVerifyResponse> AccountVerifyWithHttpInfo(AccountVerifyRequest accountVerifyRequest, int operationIndex = 0)
        {
            // verify the required parameter 'accountVerifyRequest' is set
            if (accountVerifyRequest == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'accountVerifyRequest' when calling AccountApi->AccountVerify");
            }
        ...
        {
            Org.HelloSign.Client.ApiResponse<AccountVerifyResponse> localVarResponse = await AccountVerifyWithHttpInfoAsync(accountVerifyRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AccountVerifyResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<AccountVerifyResponse>> AccountVerifyWithHttpInfoAsync(AccountVerifyRequest accountVerifyRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'accountVerifyRequest' is set
            if (accountVerifyRequest == null)
            {
