...
namespace Org.HelloSign.Api
{
    ...
    public partial class OAuthApi : IOAuthApi
    {
        ...
        /// <returns></returns>
        public OAuthApi(Org.HelloSign.Client.Configuration configuration)
        {
        ...
        public OAuthApi(Org.HelloSign.Client.ISynchronousClient client, Org.HelloSign.Client.IAsynchronousClient asyncClient, Org.HelloSign.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.HelloSign.Client.ApiResponse<OAuthTokenResponse> localVarResponse = OauthTokenGenerateWithHttpInfo(oAuthTokenGenerateRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of OAuthTokenResponse</returns>
        public Org.HelloSign.Client.ApiResponse<OAuthTokenResponse> OauthTokenGenerateWithHttpInfo(OAuthTokenGenerateRequest oAuthTokenGenerateRequest, int operationIndex = 0)
        {
            // verify the required parameter 'oAuthTokenGenerateRequest' is set
            if (oAuthTokenGenerateRequest == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'oAuthTokenGenerateRequest' when calling OAuthApi->OauthTokenGenerate");
            }
        ...
        {
            Org.HelloSign.Client.ApiResponse<OAuthTokenResponse> localVarResponse = await OauthTokenGenerateWithHttpInfoAsync(oAuthTokenGenerateRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OAuthTokenResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<OAuthTokenResponse>> OauthTokenGenerateWithHttpInfoAsync(OAuthTokenGenerateRequest oAuthTokenGenerateRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'oAuthTokenGenerateRequest' is set
            if (oAuthTokenGenerateRequest == null)
            {
        ...
        {
            Org.HelloSign.Client.ApiResponse<OAuthTokenResponse> localVarResponse = OauthTokenRefreshWithHttpInfo(oAuthTokenRefreshRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of OAuthTokenResponse</returns>
        public Org.HelloSign.Client.ApiResponse<OAuthTokenResponse> OauthTokenRefreshWithHttpInfo(OAuthTokenRefreshRequest oAuthTokenRefreshRequest, int operationIndex = 0)
        {
            // verify the required parameter 'oAuthTokenRefreshRequest' is set
            if (oAuthTokenRefreshRequest == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'oAuthTokenRefreshRequest' when calling OAuthApi->OauthTokenRefresh");
            }
        ...
        {
            Org.HelloSign.Client.ApiResponse<OAuthTokenResponse> localVarResponse = await OauthTokenRefreshWithHttpInfoAsync(oAuthTokenRefreshRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (OAuthTokenResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<OAuthTokenResponse>> OauthTokenRefreshWithHttpInfoAsync(OAuthTokenRefreshRequest oAuthTokenRefreshRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'oAuthTokenRefreshRequest' is set
            if (oAuthTokenRefreshRequest == null)
            {
