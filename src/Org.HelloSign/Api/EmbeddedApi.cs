...
namespace Org.HelloSign.Api
{
    ...
    public partial class EmbeddedApi : IEmbeddedApi
    {
        ...
        /// <returns></returns>
        public EmbeddedApi(Org.HelloSign.Client.Configuration configuration)
        {
        ...
        public EmbeddedApi(Org.HelloSign.Client.ISynchronousClient client, Org.HelloSign.Client.IAsynchronousClient asyncClient, Org.HelloSign.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.HelloSign.Client.ApiResponse<EmbeddedEditUrlResponse> localVarResponse = EmbeddedEditUrlWithHttpInfo(templateId, embeddedEditUrlRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EmbeddedEditUrlResponse</returns>
        public Org.HelloSign.Client.ApiResponse<EmbeddedEditUrlResponse> EmbeddedEditUrlWithHttpInfo(string templateId, EmbeddedEditUrlRequest embeddedEditUrlRequest, int operationIndex = 0)
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'templateId' when calling EmbeddedApi->EmbeddedEditUrl");
            }

            // verify the required parameter 'embeddedEditUrlRequest' is set
            if (embeddedEditUrlRequest == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'embeddedEditUrlRequest' when calling EmbeddedApi->EmbeddedEditUrl");
            }
        ...
        {
            Org.HelloSign.Client.ApiResponse<EmbeddedEditUrlResponse> localVarResponse = await EmbeddedEditUrlWithHttpInfoAsync(templateId, embeddedEditUrlRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EmbeddedEditUrlResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<EmbeddedEditUrlResponse>> EmbeddedEditUrlWithHttpInfoAsync(string templateId, EmbeddedEditUrlRequest embeddedEditUrlRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'templateId' is set
            if (templateId == null)
            {
        ...
        {
            Org.HelloSign.Client.ApiResponse<EmbeddedSignUrlResponse> localVarResponse = EmbeddedSignUrlWithHttpInfo(signatureId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of EmbeddedSignUrlResponse</returns>
        public Org.HelloSign.Client.ApiResponse<EmbeddedSignUrlResponse> EmbeddedSignUrlWithHttpInfo(string signatureId, int operationIndex = 0)
        {
            // verify the required parameter 'signatureId' is set
            if (signatureId == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'signatureId' when calling EmbeddedApi->EmbeddedSignUrl");
            }
            ...
            localVarRequestOptions.PathParameters.Add("signature_id", Org.HelloSign.Client.ClientUtils.ParameterToString(signatureId)); // path parameter
        ...
        {
            Org.HelloSign.Client.ApiResponse<EmbeddedSignUrlResponse> localVarResponse = await EmbeddedSignUrlWithHttpInfoAsync(signatureId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (EmbeddedSignUrlResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<EmbeddedSignUrlResponse>> EmbeddedSignUrlWithHttpInfoAsync(string signatureId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'signatureId' is set
            if (signatureId == null)
            {
