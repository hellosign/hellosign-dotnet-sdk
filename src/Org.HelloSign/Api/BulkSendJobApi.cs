...
namespace Org.HelloSign.Api
{
    ...
    public partial class BulkSendJobApi : IBulkSendJobApi
    {
        ...
        /// <returns></returns>
        public BulkSendJobApi(Org.HelloSign.Client.Configuration configuration)
        {
        ...
        public BulkSendJobApi(Org.HelloSign.Client.ISynchronousClient client, Org.HelloSign.Client.IAsynchronousClient asyncClient, Org.HelloSign.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Org.HelloSign.Client.ApiResponse<BulkSendJobGetResponse> localVarResponse = BulkSendJobGetWithHttpInfo(bulkSendJobId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkSendJobGetResponse</returns>
        public Org.HelloSign.Client.ApiResponse<BulkSendJobGetResponse> BulkSendJobGetWithHttpInfo(string bulkSendJobId, int operationIndex = 0)
        {
            // verify the required parameter 'bulkSendJobId' is set
            if (bulkSendJobId == null)
            {
                throw new Org.HelloSign.Client.ApiException(400, "Missing required parameter 'bulkSendJobId' when calling BulkSendJobApi->BulkSendJobGet");
            }
            ...
            localVarRequestOptions.PathParameters.Add("bulk_send_job_id", Org.HelloSign.Client.ClientUtils.ParameterToString(bulkSendJobId)); // path parameter
        ...
        {
            Org.HelloSign.Client.ApiResponse<BulkSendJobGetResponse> localVarResponse = await BulkSendJobGetWithHttpInfoAsync(bulkSendJobId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkSendJobGetResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<BulkSendJobGetResponse>> BulkSendJobGetWithHttpInfoAsync(string bulkSendJobId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'bulkSendJobId' is set
            if (bulkSendJobId == null)
            {
        ...
        {
            Org.HelloSign.Client.ApiResponse<BulkSendJobListResponse> localVarResponse = BulkSendJobListWithHttpInfo(page, pageSize);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BulkSendJobListResponse</returns>
        public Org.HelloSign.Client.ApiResponse<BulkSendJobListResponse> BulkSendJobListWithHttpInfo(int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0)
        {
            Org.HelloSign.Client.RequestOptions localVarRequestOptions = new Org.HelloSign.Client.RequestOptions();
        ...
        {
            Org.HelloSign.Client.ApiResponse<BulkSendJobListResponse> localVarResponse = await BulkSendJobListWithHttpInfoAsync(page, pageSize, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BulkSendJobListResponse)</returns>
        public async System.Threading.Tasks.Task<Org.HelloSign.Client.ApiResponse<BulkSendJobListResponse>> BulkSendJobListWithHttpInfoAsync(int? page = default(int?), int? pageSize = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
