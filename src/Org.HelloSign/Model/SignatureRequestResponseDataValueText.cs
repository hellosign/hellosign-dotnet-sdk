...
namespace Org.HelloSign.Model
{
    ...
    public partial class SignatureRequestResponseDataValueText : SignatureRequestResponseData, IOpenApiTyped, IEquatable<SignatureRequestResponseDataValueText>, IValidatableObject
    {
        /// <summary>
