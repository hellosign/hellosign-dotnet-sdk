...
namespace HelloSign.Model
{
    ...
    public partial class SubFormFieldsPerDocumentSignature : SubFormFieldsPerDocumentBase, IOpenApiTyped, IEquatable<SubFormFieldsPerDocumentSignature>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SubFormFieldsPerDocumentSignature" /> class.
        /// </summary>
        /// <param name="type">A signature input field. Use the &#x60;SubFormFieldsPerDocumentSignature&#x60; class. (required) (default to &quot;signature&quot;).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubFormFieldsPerDocumentSignature {\n");
        ...
        {
            return this.Equals(input as SubFormFieldsPerDocumentSignature);
        }

        /// <summary>
        /// Returns true if SubFormFieldsPerDocumentSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of SubFormFieldsPerDocumentSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubFormFieldsPerDocumentSignature input)
        {
            if (input == null)
            {
                return false;
