...
namespace HelloSign.Model
{
    ...
    public partial class AccountVerifyResponse : IOpenApiTyped, IEquatable<AccountVerifyResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AccountVerifyResponse);
        }

        /// <summary>
        /// Returns true if AccountVerifyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountVerifyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountVerifyResponse input)
        {
            if (input == null)
            {
                return false;
