...
namespace HelloSign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamParentResponse")]
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public partial class TeamParentResponse : IOpenApiTyped, IEquatable<TeamParentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TeamParentResponse);
        }

        /// <summary>
        /// Returns true if TeamParentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamParentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamParentResponse input)
        {
            if (input == null)
            {
                return false;
