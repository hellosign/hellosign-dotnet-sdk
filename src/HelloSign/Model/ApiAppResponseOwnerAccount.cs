...
namespace HelloSign.Model
{
    ...
    public partial class ApiAppResponseOwnerAccount : IOpenApiTyped, IEquatable<ApiAppResponseOwnerAccount>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ApiAppResponseOwnerAccount);
        }

        /// <summary>
        /// Returns true if ApiAppResponseOwnerAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiAppResponseOwnerAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiAppResponseOwnerAccount input)
        {
            if (input == null)
            {
                return false;
