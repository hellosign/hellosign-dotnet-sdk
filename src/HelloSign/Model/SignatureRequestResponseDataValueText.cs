...
namespace HelloSign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SignatureRequestResponseDataValueText")]
    ...
    public partial class SignatureRequestResponseDataValueText : SignatureRequestResponseDataBase, IOpenApiTyped, IEquatable<SignatureRequestResponseDataValueText>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureRequestResponseDataValueText" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SignatureRequestResponseDataValueText() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureRequestResponseDataValueText" /> class.
        /// </summary>
        /// <param name="type">A text input field (default to &quot;text&quot;).</param>
        ...
        public SignatureRequestResponseDataValueText(string type = "text", string value = default(string), string apiId = default(string), string signatureId = default(string), string name = default(string), bool required = default(bool))
        {
            this.ApiId = apiId;
        ...
        /// A text input field
        /// </summary>
        /// <value>A text input field</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignatureRequestResponseDataValueText {\n");
        ...
        {
            return this.Equals(input as SignatureRequestResponseDataValueText);
        }

        /// <summary>
        /// Returns true if SignatureRequestResponseDataValueText instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureRequestResponseDataValueText to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureRequestResponseDataValueText input)
        {
            if (input == null)
            {
                return false;
