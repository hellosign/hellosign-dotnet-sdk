...
namespace HelloSign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateCreateEmbeddedDraftResponse")]
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public partial class TemplateCreateEmbeddedDraftResponse : IOpenApiTyped, IEquatable<TemplateCreateEmbeddedDraftResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TemplateCreateEmbeddedDraftResponse);
        }

        /// <summary>
        /// Returns true if TemplateCreateEmbeddedDraftResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateCreateEmbeddedDraftResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateCreateEmbeddedDraftResponse input)
        {
            if (input == null)
            {
                return false;
