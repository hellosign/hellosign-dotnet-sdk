...
namespace HelloSign.Model
{
    ...
    public partial class SignatureRequestResponseDataValueRadio : SignatureRequestResponseDataBase, IOpenApiTyped, IEquatable<SignatureRequestResponseDataValueRadio>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SignatureRequestResponseDataValueRadio {\n");
        ...
        {
            return this.Equals(input as SignatureRequestResponseDataValueRadio);
        }

        /// <summary>
        /// Returns true if SignatureRequestResponseDataValueRadio instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureRequestResponseDataValueRadio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureRequestResponseDataValueRadio input)
        {
            if (input == null)
            {
                return false;
