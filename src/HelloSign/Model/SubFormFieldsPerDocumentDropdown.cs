...
namespace HelloSign.Model
{
    ...
    public partial class SubFormFieldsPerDocumentDropdown : SubFormFieldsPerDocumentBase, IOpenApiTyped, IEquatable<SubFormFieldsPerDocumentDropdown>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SubFormFieldsPerDocumentDropdown" /> class.
        /// </summary>
        /// <param name="type">An input field for dropdowns. Use the &#x60;SubFormFieldsPerDocumentDropdown&#x60; class. (required) (default to &quot;dropdown&quot;).</param>
        ...
        {
            return this.Equals(input as SubFormFieldsPerDocumentDropdown);
        }

        /// <summary>
        /// Returns true if SubFormFieldsPerDocumentDropdown instances are equal
        /// </summary>
        /// <param name="input">Instance of SubFormFieldsPerDocumentDropdown to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubFormFieldsPerDocumentDropdown input)
        {
            if (input == null)
            {
                return false;
