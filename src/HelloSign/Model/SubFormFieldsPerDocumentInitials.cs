...
namespace HelloSign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubFormFieldsPerDocumentInitials")]
    ...
    public partial class SubFormFieldsPerDocumentInitials : SubFormFieldsPerDocumentBase, IOpenApiTyped, IEquatable<SubFormFieldsPerDocumentInitials>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubFormFieldsPerDocumentInitials" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubFormFieldsPerDocumentInitials() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubFormFieldsPerDocumentInitials" /> class.
        /// </summary>
        /// <param name="type">An input field for initials. Use the &#x60;SubFormFieldsPerDocumentInitials&#x60; class. (required) (default to &quot;initials&quot;).</param>
        ...
        public SubFormFieldsPerDocumentInitials(string type = "initials", int documentIndex = default(int), string apiId = default(string), int height = default(int), string name = default(string), int? page = default(int?), bool required = default(bool), string signer = default(string), int width = default(int), int x = default(int), int y = default(int))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for SubFormFieldsPerDocumentInitials and cannot be null");
            }
            this.Type = type;
        }
        ...
        {
            return this.Equals(input as SubFormFieldsPerDocumentInitials);
        }

        /// <summary>
        /// Returns true if SubFormFieldsPerDocumentInitials instances are equal
        /// </summary>
        /// <param name="input">Instance of SubFormFieldsPerDocumentInitials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubFormFieldsPerDocumentInitials input)
        {
            if (input == null)
            {
                return false;
