...
namespace HelloSign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SignatureRequestResponseDataValueDropdown")]
    ...
    public partial class SignatureRequestResponseDataValueDropdown : SignatureRequestResponseDataBase, IOpenApiTyped, IEquatable<SignatureRequestResponseDataValueDropdown>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureRequestResponseDataValueDropdown" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SignatureRequestResponseDataValueDropdown() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SignatureRequestResponseDataValueDropdown" /> class.
        /// </summary>
        /// <param name="type">An input field for dropdowns (default to &quot;dropdown&quot;).</param>
        ...
        public SignatureRequestResponseDataValueDropdown(string type = "dropdown", string value = default(string), string apiId = default(string), string signatureId = default(string), string name = default(string), bool required = default(bool))
        {
            this.ApiId = apiId;
        ...
        /// </summary>
        /// <value>An input field for dropdowns</value>
        ...
        {
            return this.Equals(input as SignatureRequestResponseDataValueDropdown);
        }

        /// <summary>
        /// Returns true if SignatureRequestResponseDataValueDropdown instances are equal
        /// </summary>
        /// <param name="input">Instance of SignatureRequestResponseDataValueDropdown to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignatureRequestResponseDataValueDropdown input)
        {
            if (input == null)
            {
                return false;
